# 收钱吧开放平台 Node SDK [![NPM version](http://img.shields.io/npm/v/open-service-node-sdk.svg?style=flat)](https://npmjs.org/package/open-service-node-sdk)

[![Coverage Status](https://coveralls.io/repos/github/xuyuanxiang/open-service-node-sdk/badge.svg?branch=1.0.0)](https://coveralls.io/github/xuyuanxiang/open-service-node-sdk?branch=1.0.0)
